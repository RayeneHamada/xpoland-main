...
function FreeInscription({ exhibitionId, setInscriptionSelected, setParticipationSelected }: any) {
    ...
    const submit = async (value: any) => {
        ...
        try {
            const response = await participateFreely(payload);
                    ...
                    {success ?
                        <>
                            <Result
                                ...
                                extra={[
                                    <Button className="stepButton" key="console" onClick={() => {setParticipationSelected(true);setInscriptionSelected(false)}} >
                                        Se connecter
                                    </Button>
                                ]}
                            />
